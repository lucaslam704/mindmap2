      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={[styles.taskInfo, { color: theme.colors.textSecondary }]}>Due Date: {item.dueDate ? item.dueDate.toLocaleString(undefined, { year: 'numeric', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' }) : "No due date"}</Text>
